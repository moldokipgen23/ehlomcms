...
<div class="eos-row" style="gap:20px;max-width:1200px;">
    ...
    <div style="flex:1;min-width:0;display:flex;flex-direction:column;gap:16px;">
        ...
        @foreach ($businessTypes as $typeKey => $type)
            <div class="eos-card business-type-card" data-type="{{ $typeKey }}" style="display:none;">
                ...
                <div class="eos-card-body" style="padding:16px;display:flex;flex-direction:column;gap:16px;">
                    ...
                    {{-- MODULES TOGGLES --}}
                    <div>
                        <div style="font-weight:600;font-size:12px;color:var(--text-secondary);margin-bottom:8px;">Modules</div>
                        <div style="display:flex;flex-wrap:wrap;gap:6px;">
                            ...
                            @if (empty($typeModules))
                                <span style="font-size:11px;color:var(--text-dim);">No modules for this type</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div>
                        <div style="font-weight:600;font-size:12px;color:var(--text-secondary);margin-bottom:8px;">Theme Template</div>
                        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:10px;">
                            ...
                            @endforeach
                            @if (empty($typeThemes))
                                <span style="font-size:11px;color:var(--text-dim);">No themes for this type</span>
                            @endif
                        </div>
                    </div>
        ...
        {{-- FALLBACK: All Themes Card (for types without specific themes) --}}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Legacy template select dropdown (if exists)
