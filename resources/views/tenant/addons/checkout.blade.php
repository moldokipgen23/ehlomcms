        ...
        <div class="eos-card-body">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;">
                ...
                <div>
                    ...
                    <div style="font-size:14px;color:var(--text-muted);">₹{{ number_format($addon->price, 0) }}/month</div>
                </div>
            </div>
            ...
            <p style="font-size:12px;color:var(--text-muted);text-align:center;margin-top:16px;">
                You'll be redirected to Razorpay for secure payment. Subscription auto-renews monthly.
            </p>
        </div>
    </div>
</div>
